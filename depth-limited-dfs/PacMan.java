...
public class PacMan {
    ...
    public static void main(String[] args) {
        int i;
        int source, destination, depthLimit;
	Map map;
	...
	if (findRoute(map, source, destination, visited, theQueue, parent, depth, depthLimit)) {
    ...
    static boolean findRoute(Map map, int source,
			     ...
			     int[] parent, int[] depth, int maxDepth)
    {
      int neighbour, j, curr_junction;
    	...
    	while (!dest_found && !theQueue.empty()) {
    	    ...
    	    if (!dest_found && curr_depth < maxDepth){
